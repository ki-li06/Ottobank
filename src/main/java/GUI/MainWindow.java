...
public class MainWindow{
    ...
    MainWindow() {
        ...
        StackedWidget layerManager = new StackedWidget(mainFrame);
        StackedPane loginPage = new StackedPane(layerManager, new Dimension(400, 500));

        layerManager.registerPane(loginPage);
        ...
        loginPage.registerComponent(infoLabel);
        ...
        loginPage.registerComponent(usernameTextField);
